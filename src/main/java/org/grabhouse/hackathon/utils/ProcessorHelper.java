package org.grabhouse.hackathon.utils;
...
import org.grabhouse.hackathon.service.GeocodingService;
...
public class ProcessorHelper {
	...
	public static GeocodingService createWebHookService(final String url) {
	...
	public static String getResponse(final Response response) {
		BufferedReader reader = null;
        StringBuilder sb = new StringBuilder();
        try {
